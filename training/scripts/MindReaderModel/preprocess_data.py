...
def load_and_preprocess_subject_data(subject_id, session_type='T', data_path=DATA_PATH,
    ...
    # raw.pick_channels(eeg_channels) # Apply pick later after filtering 
    ...
    try:
        ...
        # Map desired task names ('left_hand', etc.) to the MNE integer IDs
        ...
        # Checking if any of these mapped MNE IDs actually exist in the events array
